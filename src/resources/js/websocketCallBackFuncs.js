...
import { canvas, resetCamera, fitToFrame } from './canvas.js';

export var wsCallbackFuncs = {};

wsCallbackFuncs["initializeSession"] = initializeSession;
wsCallbackFuncs["syncParams"] = syncParams;
wsCallbackFuncs["syncCursors"] = syncCursors;
wsCallbackFuncs["syncMeshes"] = syncMeshes;
wsCallbackFuncs["syncLoadingState"] = syncLoadingState;
...
async function initializeSession(j) {
    if ("sessionId" in j && DoppelCore.sessionId < 0) {
        DoppelCore.sessionId = j["sessionId"];
